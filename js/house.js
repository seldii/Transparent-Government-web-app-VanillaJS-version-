var houseData = {
 ...
 var members = houseData.results[0].members;
 var democratsArr = [];
 var republicanArr = [];
 var independentArr = [];
 ...
 //Totals
 statistic.Total.NoOfReps = JSON.stringify(houseData.results[0].members.length);

 statistic.Total.AveVotedWParty = averageVoteWithParty(houseData.results[0].members);

 //

 statistic.Total.LeastEngagedGuys = JSON.stringify(leastEngagedTenPercent(members));
 statistic.Total.MostEngagedGuys = JSON.stringify(mostEngagedTenPercent(members));
 statistic.Total.LeastLoyalGuys = JSON.stringify(leastLoyalTenPercent(members));
 ...
 if (document.title.indexOf("Attendance") != -1) {
 ...
 //Loyalty Page Tables
 //
 if (document.title.indexOf("Loyalty") != -1) {
