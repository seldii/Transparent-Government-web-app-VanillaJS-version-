 ...
 //Totals
 statistic.Total.NoOfReps = JSON.stringify(senateData.results[0].members.length);

 statistic.Total.AveVotedWParty = averageVoteWithParty(senateData.results[0].members);
